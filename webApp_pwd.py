...
if st.session_state.stato_quiz == 'setup':
    ...
    opzioni_sorgente = ["DATABASE 1.txt", "DATABASE 2.txt", "DATABASE 3.txt", "DATABASE 4(1).txt", "DATABASE 4(2).txt", "DATABASE_Q7 (MicrobiologiaVirologia).txt", "DATABASE Q8 (microbiologia e virologia).txt", "DATABASE Q8 (genetica).txt", "DATABASE_Q9 (immunoematologia e medicina trasfusionale).txt", "Tutti i DATABASE", "Carica file .txt"]
